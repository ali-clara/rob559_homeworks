...
def generate_launch_description():
    ...
    turtlebot_envvar = SetEnvironmentVariable(
    ...
    # Use "slam_launch.py" and "navigation_launch.py" from the nav2_bringup package
        # to start slam and navigation
    ...
    # Set environment variables
    ld.add_action(turtlebot_envvar)
